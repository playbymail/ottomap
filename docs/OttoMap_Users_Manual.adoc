...
OttoMap is a tool that converts TribeNet turn report files into Worldographer `.wxx` map files. This manual provides detailed instructions for using OttoMap from the command line.
